...
- Added configurable role name tag suffixes (red `[H]` for hunters, green `[R]` for runners) using MiniMessage; toggleable for the overhead nametag and tab list via `nameTags` in `config.yml`
