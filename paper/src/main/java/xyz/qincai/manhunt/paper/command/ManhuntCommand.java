package xyz.qincai.manhunt.paper.command;
...
public class ManhuntCommand implements CommandExecutor, TabCompleter {
    ...
    public ManhuntCommand(PaperManhuntNG plugin) {
        this.plugin = plugin;
    }
    ...
    private boolean handleLeave(CommandSender sender, String[] args) {
        ...
        plugin.getPlayerRegistry().removePlayerFromGame(player.getUniqueId());
    ...
    private boolean handleReload(CommandSender sender, String[] args) {
        ...
        plugin.getConfigProvider().reloadConfigs();
    ...
    private boolean handleRunner(CommandSender sender, String[] args) {
        ...
        plugin.getPlayerRegistry().removePlayerFromGame(target.getUniqueId());
        plugin.getPlayerRegistry().setRole(target.getUniqueId(), PlayerRole.RUNNER);
    ...
    private boolean handleHunter(CommandSender sender, String[] args) {
        ...
        plugin.getPlayerRegistry().removePlayerFromGame(target.getUniqueId());
        plugin.getPlayerRegistry().setRole(target.getUniqueId(), PlayerRole.HUNTER);
    ...
    private boolean handleRemove(CommandSender sender, String[] args) {
        ...
        if (plugin.getPlayerRegistry().isRunner(targetUuid)) {
            match.setRunnerUuid(null);
            plugin.getPlayerRegistry().removePlayerFromGame(targetUuid);
            sender.sendMessage(Component.text(target.getName(), NamedTextColor.AQUA)
        ...
        } else if (plugin.getPlayerRegistry().isHunter(targetUuid)) {
            plugin.getPlayerRegistry().removePlayerFromGame(targetUuid);
            sender.sendMessage(Component.text(target.getName(), NamedTextColor.AQUA)
